...
| **DELETE**  | `/peliculas/{id}` | Eliminar película | Ninguno | 204 No Content, 404 Not Found |
...
| **DELETE**  | `/salas/{id}` | Eliminar sala | Ninguno | 204 No Content |
...
| **DELETE**  | `/usuarios/{id}` | Eliminar usuario | Ninguno | 204 No Content |
...
| **DELETE**  | `/reservas/{id}` | Cancelar reserva | Ninguno | 204 No Content |
| **POST**    | `/pagos` | Registrar pago de una reserva | `{ "reservaId": "r123", "monto": 25.00, "metodo": "tarjeta" }` | 201 Created |
