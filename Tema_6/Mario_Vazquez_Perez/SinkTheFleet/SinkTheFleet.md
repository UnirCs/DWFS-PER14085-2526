...
| PUT | /games/{id} | - | `{"status": "in_progress"}` | `{"id": "uuid", "status": "in_progress", "currentTurn": "player1"}` | 200, 400, 404, 409 |
| PATCH | /games/{id}/start | - | - | `{"id": "uuid", "status": "in_progress", "startedAt": "..."}` | 200, 400, 404, 409 |
| PATCH | /games/{id}/finish | - | `{"winner": "player1"}` | `{"id": "uuid", "status": "finished", "winner": "player1", "finishedAt": "..."}` | 200, 400, 404 |
