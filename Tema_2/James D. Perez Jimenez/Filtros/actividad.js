...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let i = 0; i < height; i++) {
    ...
    for (let j = 0; j < width; j++) {
      ...
      let cPixel = catPixels[i][j];
      let dPixel = dogPixels[i][j];

      let r = Math.round(cPixel[0] * alphaFirst + dPixel[0] * alphaSecond);
      let g = Math.round(cPixel[1] * alphaFirst + dPixel[1] * alphaSecond);
      let b = Math.round(cPixel[2] * alphaFirst + dPixel[2] * alphaSecond);
